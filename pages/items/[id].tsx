        ...
        <div className="mb-8">
          ...
          <div className="mt-5">
            ...
            <div className="flex items-center justify-between space-x-2">
              <button className="flex-1 bg-orange-500 text-white py-3 rounded-md font-medium
                  hover:bg-orange-600
                  active:bg-orange-700
                  focus:outline-none focus:ring-1 focus:ring-orange-500
              ">Talk to seller</button>
              <button className="p-3 flex items-center justify-center text-gray-400 rounded-md
                  hover:bg-gray-100 hover:texrt-gray-500
                  focus:outline-none focus:ring-1 focus:ring-orange-500">
                <svg
                  className="h-6 w-6 "
