        ...
        <div className="mt-8">
          {
            data?.ok ? (
              <form onSubmit={tokenHandleSubmit(onTokenValid)} className="flex flex-col mt-8">
                ...
                name="token" label="Confirmation Token" type="number" required></Input>
                ...
                <form onSubmit={handleSubmit(onValid)} className="flex flex-col mt-8">
                  {method === "email" ? 
                    <Input register={register("email", {
                      required: true
                    })} label="Email address" type="email" required></Input> 
                  : null}
                  {method === "phone" ? 
                    <Input register={register("phone", {
                      required: true
                    })} label="Phone number" kind="phone" required></Input> 
                  : null}
